...
INSERT INTO beer(id_beer, name, description, ibu, alcohol_percent, image_path, style) VALUES
    (1, 'Molson Canadian', 'Une bière avec une feuille d''érable dessus...', 15, 5.0, 'https://decrescente.net/images/suppliers/millercoors/molson/molson-canadian/canadian-bottle-lg.png', 'Light lager'),
    (2, 'Blue', 'Une bière bleu... Étrange', 12, 5.0, 'https://www.google.com/url?sa=i&source=images&cd=&cad=rja&uact=8&ved=2ahUKEwir8pfW-7DbAhWr5oMKHX3oDtMQjRx6BAgBEAU&url=https%3A%2F%2Fwww.liquormarts.ca%2Fproduct%2Flabatt-blue%2F24-x-355-ml&psig=AOvVaw1n1N32iTLqUZu3QGlvQy7F&ust=1527891003844616', 'Light lager'),
    (3, 'Don de Dieu', 'Une bière pas bonne qui souale...', 10, 9.0, 'https://res.cloudinary.com/ratebeer/image/upload/d_beerdefault_m1aurr.png,f_auto/beer_1929', 'Belgian strong pale ale'),
    (4, 'Péché Mortel', 'La seule bonne bière du site.', 76, 9.5, 'http://images.lpcdn.ca/641x427/201703/31/1377153.jpg', 'Imperial stout'),
    (5, 'Ingénieuse', 'Bière collaborative.', 17, 5.1, 'https://cdn.narcity.com/uploads/249500_90d9f57c70a3e15b6e0a08e67dcf1d944038212a.jpg', 'Irish ale');
